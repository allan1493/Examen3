...
<body>
    <form id="form1" runat="server">
        ...
        <div class="center">
             ...
             <asp:Image CssClass="Imagen" ID="Image2" runat="server" ImageUrl="~/Imagenes/carro.png"/>
                ...
                <div class="text_Field">
                    ...
                    <asp:TextBox CssClass="texbox" ID="TextBox1" runat="server" Width="490px" Height="30px"></asp:TextBox>
                </div>
                <div class="text_Field">
                    
                    <asp:TextBox CssClass="texbox" ID="TextBox2" runat="server" TextMode="Password" Width="491px" Height="41px"></asp:TextBox>
